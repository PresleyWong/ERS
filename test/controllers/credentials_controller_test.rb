...
class CredentialsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create credential" do
    assert_difference('Credential.count') do
      post credentials_url, params: { credential: { api_key: @credential.api_key, api_name: @credential.api_name, api_secret: @credential.api_secret } }
    end
  ...
  test "should update credential" do
    patch credential_url(@credential), params: { credential: { api_key: @credential.api_key, api_name: @credential.api_name, api_secret: @credential.api_secret } }
